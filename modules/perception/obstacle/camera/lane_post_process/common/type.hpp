...
// @file: type.hpp
// @brief: type definition for lane post processing
...
#ifndef ADU_PERCEPTION_OBSTACLE_CAMERA_LANE_POST_PROCESS_COMMON_TYPE_HPP
#define ADU_PERCEPTION_OBSTACLE_CAMERA_LANE_POST_PROCESS_COMMON_TYPE_HPP
...
struct Marker {
    ...
    static bool comp(const Marker& a, const Marker& b) {
        ...
        return (a.space_type == SpaceType::IMAGE) ?
...
struct CCLaneTrack {
    SpaceType space_type;
    //SpatialLabelType spatial_label;
    //SemanticLabelType semantic_label;
    ...
    CCLaneTrack()
        : space_type(SpaceType::EGO_CAR) {
          //spatial_label(SpatialLabelType::L_0),
          //semantic_label(SemanticLabelType::UNKNOWN) {
        tot_point_num = 0;
        segments.clear();
        lateral_dist = 0.0;
    ...
    ScalarType x_min() const { return bbox(0); }
    ScalarType y_min() const { return bbox(1); }
    ScalarType x_max() const { return bbox(2); }
    ScalarType y_max() const { return bbox(3); }
};
...
#endif  // ADU_PERCEPTION_OBSTACLE_CAMERA_LANE_POST_PROCESS_COMMON_TYPE_HPP
