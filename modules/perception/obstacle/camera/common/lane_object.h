...
// @author: Tae Eun Choe (choetaeeun@baidu.com)
// @file: lane_object.h
// @brief: constants, structs and classes related lane line

#ifndef ADU_PERCEPTION_OBSTACLE_CAMERA_COMMON_LANE_OBJECT_H
#define ADU_PERCEPTION_OBSTACLE_CAMERA_COMMON_LANE_OBJECT_H
...
// The width of virtual egolane when there is only one lane line, 
const float HALF_VEHICLE_WIDTH_IN_METER = MAX_VEHICLE_WIDTH_IN_METER / 2.0f; // 1.25f
...
#endif  // ADU_PERCEPTION_OBSTACLE_CAMERA_COMMON_LANE_OBJECT_H
