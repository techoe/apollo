...
#ifndef ADU_PERCEPTION_OBSTACLE_CAMERA_CIPV_H
#define ADU_PERCEPTION_OBSTACLE_CAMERA_CIPV_H
...
class Cipv {
 ...
 private:
  ...
  // Determine CIPV among multiple objects
  bool get_egolane(const lane_post_process::LaneObjectsPtr lane_objects,
                   EgoLane *egolane_image, EgoLane *egolane_ground,
                   bool *b_left_valid, bool *b_right_valid);

  // Elongate lane line
  bool elongate_egolane(const lane_post_process::LaneObjectsPtr lane_objects,
